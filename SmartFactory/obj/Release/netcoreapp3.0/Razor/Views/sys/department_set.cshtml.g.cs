#pragma checksum "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "11e3ebb2b6cfb9ab4ffa57378c48b09244c1a71a"
// <auto-generated/>
...
#nullable disable
    ...
    public class Views_sys_department_set : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<SmartFactory.Models.department>
    {
        ...
        {
#nullable restore
#line 2 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 13 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable disable
#nullable restore
#line 15 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 17 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 21 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 27 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable disable
            WriteLiteral("</label>\r\n                                    <div class=\"col-md-4\">\r\n\r\n                                        ");
#nullable restore
#line 30 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable disable
            WriteLiteral(@"
                            ...
                            <div class=""form-group"">
                                <label class=""col-sm-2 control-label""> ");
#nullable restore
#line 43 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                                                                  Write(SmartFactory.Util.get_word.language_code(language, "department"));
...
#nullable disable
            WriteLiteral("</label>\r\n                                <div class=\"col-md-6\">\r\n                                    ");
#nullable restore
#line 45 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
");
#nullable restore
#line 67 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 72 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 75 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 78 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                                                       Write(item.Text);
...
#nullable disable
            WriteLiteral("\r\n                                                        </td>\r\n                                                    </tr>\r\n");
#nullable restore
#line 81 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                                                }
...
#nullable disable
            WriteLiteral("\r\n                                            </table>\r\n");
#nullable restore
#line 84 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                                        }
...
#nullable restore
#line 87 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable disable
            ...
            WriteLiteral(" />\r\n                                </div>\r\n\r\n\r\n\r\n                            </div>\r\n\r\n                            <hr />\r\n                            <div class=\"form-group\">\r\n                                <label class=\"col-sm-2 control-label\"> ");
#nullable restore
#line 96 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                            ...
                            <div class=""form-group check_auth"">
                                <div class=""col-md-10"" style=""display: table; margin: 20px; text-align: center;"">
                                    <div class=""btn btn-default btn-fill btn-wd   btn-info"" onclick=""save_it() "">
                                        ");
#nullable restore
#line 110 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable restore
#line 117 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
...
#nullable disable
            WriteLiteral("\r\n\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </fieldset>\r\n");
#nullable restore
#line 123 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
                    }
      ...
      ");
        ...
        if (auth_name == ""insstek"") {
            ...
            $('input:checkbox[name=""department_auth""]').each(function() {
                ...
                var gubun_code = '");
#nullable restore
#line 184 "F:\공유폴더\04. 이용우\00. GoodDesign SmarFactory Web\GoodDesignWeb\SmartFactory\Views\sys\department_set.cshtml"
